        ...
        <li class="nav-item">
            <div class="headerLogo">
                <a class="navbar-brand" href="{{ route('home') }}">
                    <img src="{{ asset('assets/backend/img/logo.png') }}" alt="Pharmacy" style="height: 50px;max-width: 100px">
                </a>
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" style="display: flex;align-items: center;"
               aria-haspopup="true" aria-expanded="false">
                ...
                <span class="ml-2 d-none d-lg-inline text-black-50 small pr-2" style="font-size: 18px">{{ Auth::user()->name }}</span>
